...
export function Banner({ className, style }: { className?: string; style?: CSSProperties }) {
    ...
    return (
        <div className={cn("w-full text-sm bg-secondary text-muted-foreground flex flex-row flex-wrap justify-center py-2", className)} style={style}>
