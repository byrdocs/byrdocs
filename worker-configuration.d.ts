/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c189a9d402f1cb48268bee71cb37928a)
// Runtime types generated with workerd@1.20251001.0 2025-08-31 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "Counter" | "OAuth";
	}
	interface Env {
		JWT_SECRET: string;
		...
		COUNTER: DurableObjectNamespace<import("./worker/index").Counter>;
		OAUTH: DurableObjectNamespace<import("./worker/index").OAuth>;
		R2: R2Bucket;
		DB: D1Database;
